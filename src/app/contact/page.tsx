      ...
      <div className="container px-4 sm:px-6 lg:px-8 mx-auto">
        <div className="grid gap-8 lg:grid-cols-2">
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-4">
                <Link
                  href="#"
                  className="rounded-full bg-gray-800 p-2 text-gray-400 hover:text-white transition-colors"
                >
                  <svg
                    className="h-5 w-5"
                    fill="currentColor"
          ...
          <div className="relative">
            ...
            <Card className="relative border-gray-800 bg-gray-900/50 shadow-lg backdrop-blur">
    ...
    <section className="w-full py-12 md:py-24 bg-gray-950 relative">
      ...
      <div className="container px-4 sm:px-6 lg:px-8 mx-auto relative z-10">
        <div className="max-w-3xl mx-auto space-y-4 text-center mb-12">
          ...
          <p className="text-gray-400 md:text-lg">
            Find quick answers to common questions about our service and
            support.
          </p>
        </div>
        ...
        <div className="max-w-3xl mx-auto space-y-4">
          <FaqItem
            ...
            answer="We aim to respond to all support requests within 24 hours during business days. For urgent issues, our premium support plan offers faster response times."
          />
          <FaqItem
            question="Do you offer technical support for setting up tunnels?"
            answer="Yes, our support team can help you set up and configure your tunnels. We also have comprehensive documentation with step-by-step guides."
          />
          <FaqItem
            question="What if I need help outside of business hours?"
            answer="Our community forum is active 24/7, and many common issues have solutions documented there. For urgent issues, premium support subscribers have access to extended hours support."
          />
          <FaqItem
